...
exports.run = async (client, message, args) => {
  snekfetch.get('https://api.imgur.com/3/gallery/r/dankmemes').set("Authorization", "Client-ID 573b4804eeecb44")
  .then(r => {
    ...
    .setFooter("Source: /r/dankmemes | Also try " + config.prefix + "meme");
